...
from config import (
    SEED,
    SCALING_DEPTH, SCALING_WIDTHS, DEPTH_VALUES,
...
def run_scaling_experiment():
    ...
    for func_name, func in functions.items():
        ...
        for width in tqdm(SCALING_WIDTHS, desc=f"[fixed_depth] {func_name}"):
            _set_seed(SEED)
        ...
        for depth in tqdm(DEPTH_VALUES, desc=f"[fixed_width] {func_name}"):
            _set_seed(SEED)
    ...
    csv_path = os.path.join(RESULTS_DIR, "data", "scaling_results.csv")
